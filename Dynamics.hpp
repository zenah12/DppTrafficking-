...
public:
    ...
    // log for pools during steady state simulation
    //double uL_log[numx][numt/store_n];
    //double uSR_log[numx][numt/store_n];
    //double uSL_log[numx][numt/store_n];
    //double uSE_log[numx][numt/store_n];
    //double uSi_log[numx][numt/store_n];
